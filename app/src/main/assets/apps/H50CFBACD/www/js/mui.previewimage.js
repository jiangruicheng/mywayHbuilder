(function($, window) {
	...
	var PreviewImage = function(options) {
		this.options = $.extend(true, {
			...
			zoom: true,
			header: '<span class="mui-preview-indicator"></span><a class="mui-icon mui-pull-right xz"><i class="iconfont color-white" style="font-size:19px;margin-right:10px;" id="download"></i></a><div class="color-white mui-text-center img-inf-2-title" id="title" style=""></div><span class="color-white price" id="price"></span>',
			footer: ''
		}, options || {});
		this.init();
		this.initEvent();
